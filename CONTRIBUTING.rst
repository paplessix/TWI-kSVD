...
Welcome to ``TWI-kSVD`` contributor's guide.
...
If you experience bugs or general issues with ``TWI-kSVD``, please have a look
...
You can help improve ``TWI-kSVD`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``TWI-kSVD`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``TWI-kSVD``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n TWI-kSVD python=3 six virtualenv pytest pytest-cov
    conda activate TWI-kSVD
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/TWI-kSVD.git
    cd TWI-kSVD
...
#. Install |pre-commit|_::
   ...
   ``TWI-kSVD`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/TWI-kSVD
.. _issue tracker: https://github.com/<USERNAME>/TWI-kSVD/issues
.. <-- end -->
